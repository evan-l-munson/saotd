...
```{r merge, message=FALSE, message=FALSE, error=FALSE}
...
```{r merged_unigram, message=FALSE}
saotd::unigram(DataFrame = TD_Merge) %>% 
  dplyr::top_n(10) %>% 
  knitr::kable("html", caption = "Twitter data Uni-Grams")
```

```{r merged_bigram, message=FALSE}
saotd::bigram(DataFrame = TD_Merge) %>% 
  dplyr::top_n(10) %>% 
  knitr::kable("html", caption = "Twitter data Bi-Grams")
```

```{r merged_trigram, message=FALSE}
...
```{r bigram_network, fig.align='center'}
...
```{r corr_network, fig.align='center'}
...
```{r posneg_words, fig.align='center'}
...
```{r filtered_posneg_words, fig.align='center'}
saotd::posneg_words(DataFrameTidy = TD_Tidy, 
                    num_words = 10, 
                    filterword = "fail")
```
...
```{r number_topics_plot, fig.align='center', warning=FALSE, message=FALSE, results="hide", cache=TRUE, cache.path='saotd_cache/'}
...
```{r corpus_distribution, fig.align='center'}
...
```{r tweet_distribution, fig.align='center'}
...
```{r time_plot, fig.align='center', warning=FALSE, message=FALSE}
...
```{r topic_corpus_distribution, fig.align='center'}
...
```{r topic_tweet_distribution, fig.align='center'}
...
```{r topic_box_plot, fig.align='center'}
...
```{r topic_violin_plot, fig.align='center'}
...
```{r topic_time, fig.align='center', warning=FALSE, message=FALSE}
