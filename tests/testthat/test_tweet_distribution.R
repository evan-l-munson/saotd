...
testthat::test_that("The tweet_distribution function properly ingests data frame", {
  ...
  testthat::expect_error(
    object = saotd::tweet_distribution(DataFrameTidyScores = text), 
    "The input for this function is a data frame.")
  
  testthat::expect_error(
    object = saotd::tweet_distribution(
      DataFrameTidyScores = test_HT_Tidy_Scores, 
      HT_Topic = "HT"), 
...
testthat::test_that("The tweet_distribution plot retunrs ggplot object when using hashtags", {
...
testthat::test_that("The tweet_distribution plot retunrs ggplot object when using topics", {
