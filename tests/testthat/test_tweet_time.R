...
p <- saotd::tweet_time(DataFrameTidyScores = test_HT_Tidy_Scores, HT_Topic = "hashtag")
...
t <- saotd::tweet_time(DataFrameTidyScores = test_Topic_Tidy_Scores, HT_Topic = "topic")

# Tests
test_that("The tweet_time function properly ingests data frame", {
  
  expect_error(object = saotd::tweet_time(DataFrameTidyScores = text), "The input for this function is a data frame.")
  expect_error(object = saotd::tweet_time(DataFrameTidyScores = test_HT_Tidy_Scores, HT_Topic = "HT"), "HT_Topic requires an input of either hashtag for analysis using hashtags, or topic for analysis looking at topics.")
  
})

test_that("The tweet_time plot retunrs ggplot object when using hashtags", {
  
  expect_is(p, "ggplot")
  
})

test_that("The tweet_time plot retunrs ggplot object when using topics", {
