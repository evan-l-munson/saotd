...
# Tests
testthat::test_that("The tweet_time function properly ingests data frame", {
  
  testthat::expect_error(
    object = saotd::tweet_time(
  ...
  testthat::expect_error(
    object = saotd::tweet_time(
      DataFrameTidyScores = test_HT_Tidy_Scores, 
      HT_Topic = "HT"), 
    "HT_Topic requires an input of either hashtag for analysis using hashtags, or topic for analysis looking at topics.")
  
})

testthat::test_that("The tweet_time plot retunrs ggplot object when using hashtags", {
...
testthat::test_that("The tweet_time plot retunrs ggplot object when using topics", {
  
  expect_type(object = t,
              type =  "list")
