...
p <- SAoTD::BoxPlot(DataFrameTidyScores = test_HT_Tidy_Scores, HT_Topic = "hashtag")
...
t <- SAoTD::BoxPlot(DataFrameTidyScores = test_Topic_Tidy_Scores, HT_Topic = "topic")

# Tests
test_that("The BoxPlot function properly ingests data frame", {
  
  expect_error(object = SAoTD::BoxPlot(DataFrameTidyScores = text), "The input for this function is a data frame.")
  expect_error(object = SAoTD::BoxPlot(DataFrameTidyScores = test_HT_Tidy_Scores, HT_Topic = "HT"), "HT_Topic requires an input of either hashtag for analysis using hashtags, or topic for analysis looking at topics.")
  
})

test_that("The BoxPlot plot retunrs ggplot object when using hashtags", {
  
  expect_is(p, "ggplot")
  
})

test_that("The BoxPlot plot retunrs ggplot object when using topics", {
