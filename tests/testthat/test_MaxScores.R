...
test_that("The Max.Scores function using hashtags properly computes scores", {
  
  expect_equal(test_HT, check_HT)
  
})

test_that("The Max.Scores function using topics properly computes scores", {
  
  expect_equal(test_Topic, check_Topic)
  
})

test_that("The Max.Scores function using hashtags and a hashtag selection properly computes scores", {
